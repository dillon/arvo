    ...
    ++  ap-move-hiss
      ...
      ?.  ?&  ?=([p=* q=* r=@ s=[p=@ *]] q.vase)
        ...
        =/  =tang
          ...
          (ap-tang "hiss: bad hiss ask.{args}")
        [[%.n tang] ap-state]
      ::
      ...
      ?.  ?&  ?=([p=@ *] q.at-slot)
          ...
          ==
        =/  =tang  (ap-tang "hiss: malformed cage")
        [[%.n tang] ap-state]
      ::
      ...
      ?.  ?&  ?=(^ pax)
              (levy u.pax (sane %ta))
          ==
        =/  =tang  (ap-tang "hiss: malformed path")
        [[%.n tang] ap-state]
      ::
      ...
      ?.  ?&  ?=(^ usr)
          ...
          ==
        =/  =tang  (ap-tang "hiss: malformed (unit knot)")
        [[%.n tang] ap-state]
      ::
...
++  call
  ...
  ^-  [(list move) _gall-payload]
  ::
  ::  FIXME pull in harrison's changes
